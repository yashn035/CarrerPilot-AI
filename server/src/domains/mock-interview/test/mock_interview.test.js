...
async function runTests() {
  ...
  try {
    ...
    console.assert(profile !== null, "Test 1 Failed: Profile extraction returned null");
    console.assert(profile.skills.length > 0, "Test 1 Failed: No skills extracted");
  ...
  try {
    ...
    console.assert(question !== null, "Test 2 Failed: Question generated is null");
    console.assert(question.question !== undefined, "Test 2 Failed: No question content string");
  ...
  try {
    ...
    console.assert(evalResult.score !== undefined, "Test 3 Failed: No score calculated");
    console.assert(evalResult.score >= 5, "Test 3 Failed: Score should be elevated due to length and matching keywords");
  ...
  try {
    ...
    console.assert(report.overallScore > 0, "Test 4 Failed: Overall score is zero");
    console.assert(report.strengths.length > 0, "Test 4 Failed: No strengths logged");
  ...
  try {
    ...
    console.assert(fallbackQ.question !== undefined, "Test 5 Failed: Fallback question is missing");
